...
if __name__ == '__main__':
    ...
    unsorted_location = workflow_data[:-4] + '_' + clean_limits + '_flattened.csv'
    sorted_location = workflow_data[:-4] + '_' + clean_limits + '_sorted.csv'
    aggregated_location = workflow_data[:-4] + '_' + clean_limits + '_aggregated.csv'
